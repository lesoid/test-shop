<template>
  <div class=" card-container" style="background-color: aqua ; border: 1px solid blueviolet;">
    <div v-for="i of cardG" :key="i.id" class="card__item"
      style="background-color:aquamarine ; border: 1px solid blueviolet;">
      ...
      <div class="card__detal" style="background-color:gray ; border: 1px solid blueviolet;">
        <div class="card__caption">
          <div class="card__code">Код товара: <span>{{ i.product?.codeproduct}}</span></div>
          <a class="card__title" href="">{{  i.product?.title }}</a>
        ...
        <div class="card__control">
          <div class="counter">
            ...
            <button class="counter__btn counter__btn_plus js-counter-plus" type="button">+</button>
          </div>
          <div class="card__sum">
            <div class="card__total"><span class="product__total">sum product</span>
 ...
 <p v-for="i of cardG" :key="i.id">
    name {{ i.product }} cod {{ i.product }} штук {{}}
  </p> 
        ...
        if (user === null || user === undefined) {
          ...
          if (typeof (user.value?.id) == "number") {
           // let card = await getCard(user.value.username)
            ...
            if (card) {
              this.cardG = card
              console.log("!!!Card components JSON  image" + JSON.stringify(card[1].product))
